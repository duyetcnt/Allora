# Nội dung mới cho model.py với RandomForestRegressor
new_model_content = '''
import os
import pickle
...
def train_model():
    ...
    print(f"Trained Random Forest model saved to {model_file_path}")
'''

# Ghi lại nội dung mới vào model.py
model_file_path = '/mnt/data/basic-coin-prediction-node-main/basic-coin-prediction-node-main/model.py'

with open(model_file_path, 'w') as file:
    file.write(new_model_content)
